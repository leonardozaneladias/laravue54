...
$factory->define(Laravue54\Models\User::class, function (Faker\Generator $faker) {
    static $password;
...
$factory->define(\Laravue54\Models\UserProfile::class, function (Faker\Generator $faker) {
    return [
